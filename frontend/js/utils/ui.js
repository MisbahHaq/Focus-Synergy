...
export function showToast(message, type = 'info') {
 ...
 toast.className = `fixed bottom-6 right-6 z-50 px-4 py-3 border-2 border-black dark:border-white shadow-brutal text-xs font-extrabold uppercase tracking-wider transition-all transform translate-y-0 opacity-100 flex items-center gap-2 ${type === 'warning' ? 'bg-coral dark:bg-coral text-black' : 'bg-black dark:bg-white text-white dark:text-black'}`;
